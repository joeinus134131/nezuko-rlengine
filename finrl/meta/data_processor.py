    ...
    def __init__(self, data_source, tech_indicator=None, vix=None, **kwargs):
        if data_source == "alpaca":
            try:
                ...
                logger.info("Alpaca successfully connected")
        ...
        elif data_source == "licensed_provider":
            from finrl.meta.data_processors.processor_configured_provider import (
                ConfiguredProviderProcessor,
            )

            self.processor = ConfiguredProviderProcessor(
                profile_id=kwargs.get("PROFILE_ID", ""),
                config_path=kwargs.get("CONFIG_PATH", "configs/providers.json"),
            )
